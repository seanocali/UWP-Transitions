...
REM call :COMPILE Dissolve.hlsl   || goto END
REM call :COMPILE Mandelbrot.hlsl || goto END
REM call :COMPILE Ripples.hlsl    || goto END
REM call :COMPILE Sketch.hlsl     || goto END
REM call :COMPILE WindowSlice.hlsl     || goto END
 call :COMPILE WipeUp.hlsl     || goto END
